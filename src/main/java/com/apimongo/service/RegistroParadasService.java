...
public class RegistroParadasService {
    ...
    public RegistroParadaResponseDTO update(Integer id, RegistroParadaRequestDTO dtoRequest){
        ...
        registroExistente.setNomeMaquina(dtoRequest.getNomeMaquina());
        registroExistente.setId_usuario(dtoRequest.getId_usuario());
        registroExistente.setSetor(dtoRequest.getSetor());
    ...
    public RegistroParadaResponseDTO updatePartially(Integer id, RegistroParadaRequestDTO dto) {
        ...
        if (dto.getNomeMaquina() != null){
            registroExistente.setNomeMaquina(dto.getNomeMaquina());
            System.out.println(registroExistente.getNomeMaquina());
        }
        ...
        if (dto.getSetor() != null){
            registroExistente.setSetor(dto.getSetor());
            System.out.println(registroExistente.getSetor());
        }
